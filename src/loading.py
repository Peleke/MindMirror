...
def load_from_directory(directory_path: str) -> List[Document]:
    ...
    logging.info(f"Scanning {directory_path} for supported files: {list(supported_extensions)}")
...
def chunk_documents(documents: List[Document]) -> List[Document]:
    ...
    logging.info(f"Split {len(documents)} documents into {len(chunked_documents)} chunks.")
