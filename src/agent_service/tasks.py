...
async def index_journal_entry_task(self, entry_id: str, user_id: str, tradition: str = "canon-default"):
    """
...
@current_app.task(
    bind=True,
    name="agent_service.tasks.health_check_task",
    time_limit=60
)
...
async def reindex_user_entries_task(self, user_id: str, tradition: str = "canon-default"):
    """
