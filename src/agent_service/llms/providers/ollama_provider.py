...
class OllamaProvider(BaseProvider):
        ...
        for param in ["num_ctx", "num_gpu", "num_thread"]:
            if param in config:
                ...
                if not isinstance(value, int) or value <= 0:
                    logger.warning(
                        f"Invalid {param} value: {value}. Must be positive integer."
                    )
                    return False
    ...
    def get_model_info(self, model_name: str) -> Dict[str, Any]:
        ...
        """
        model_info = {
            "llama2": {"max_tokens": 4096, "supports_streaming": True, "size_gb": 3.8},
            "llama2:7b": {
                "max_tokens": 4096,
            ...
            "mistral": {"max_tokens": 8192, "supports_streaming": True, "size_gb": 4.1},
            "mistral:7b": {
                "max_tokens": 8192,
                "supports_streaming": True,
                "size_gb": 4.1,
