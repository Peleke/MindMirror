...
class PromptLoader:
    ...
    @trace_function(
        name="prompt_loader.load_template_from_string", tags=["prompt", "loader"]
    )
    ...
    @trace_function(
        name="prompt_loader.load_template_from_file", tags=["prompt", "loader"]
    )
    ...
    @trace_function(
        name="prompt_loader.load_templates_from_directory", tags=["prompt", "loader"]
    )
