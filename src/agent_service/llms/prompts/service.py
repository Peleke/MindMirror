...
from .exceptions import PromptNotFoundError, PromptValidationError, PromptRenderError
...
class PromptService:
    ...
    def render_prompt(self, name: str, variables: Dict[str, Any], 
    ...
    def render_prompt_safe(self, name: str, variables: Dict[str, Any],
    ...
    def update_prompt(self, name: str, content: str,
                     metadata: Optional[Dict[str, Any]] = None,
                     version: Optional[str] = None) -> PromptInfo:
    ...
    def copy_prompt(self, source_name: str, target_name: str,
                   source_version: Optional[str] = None,
                   target_version: str = "1.0") -> PromptInfo:
    ...
    def validate_prompt(self, name: str, variables: Dict[str, Any],
    ...
    def get_prompt_variables(self, name: str, version: Optional[str] = None) -> List[str]:
