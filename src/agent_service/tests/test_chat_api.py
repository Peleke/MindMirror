...
class TestChatAPI:
        ...
        with patch("agent_service.app.api.chat.ChatGraphFactory") as mock_factory:
            ...
            mock_graph.invoke.return_value = {
                ...
                "messages": [
                    ...
                    {
                        "role": "assistant",
                        "content": "Mindfulness is the practice of being present and aware of your thoughts and feelings without judgment.",
            ...
            assert (
                data["response"]
                == "Mindfulness is the practice of being present and aware of your thoughts and feelings without judgment."
            )
    ...
    def test_ask_question_error_handling(self, mock_auth_dependency):
        ...
        with patch("agent_service.app.api.chat.ChatGraphFactory") as mock_factory:
            # Mock an exception
            mock_factory.create_default_chat_graph.side_effect = Exception(
    ...
    def test_ask_question_empty_message(self, mock_auth_dependency):
        ...
        response = client.post(
            "/chat/ask", json={"message": "", "tradition_id": "test_tradition"}
        )
