...
class TestPromptServiceYAML:
    ...
    def test_yaml_prompt_rendering(self, yaml_prompt_service):
        ...
        rendered = yaml_prompt_service.render_prompt(
            "test_prompt", {"name": "Alice", "feeling": "great"}
        )
    ...
    def test_prompt_versioning(self, yaml_prompt_service):
        ...
        rendered_v1 = yaml_prompt_service.render_prompt(
            "versioned_prompt", {"input": "test"}, version="1.0"
        )
        rendered_v2 = yaml_prompt_service.render_prompt(
            "versioned_prompt", {"input": "test"}, version="2.0"
        )
...
class TestEnvironmentConfiguration:
    ...
    def test_yaml_storage_configuration(self):
        ...
        with patch.dict(
            "os.environ",
            {"PROMPT_STORE_TYPE": "yaml", "PROMPT_STORE_PATH": "/tmp/prompts"},
        ):
