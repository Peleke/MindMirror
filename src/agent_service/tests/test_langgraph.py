...
class TestStateManagement:
    ...
    def test_base_agent_state_creation(self):
        ...
        state = AgentStateFactory.create_rag_state(
            user_id="test_user", tradition="test_tradition", query="test query"
        )
    ...
    def test_state_manager_add_error(self):
        ...
        state = AgentStateFactory.create_rag_state(
            user_id="test_user", tradition="test_tradition", query="test"
        )

        error_state = StateManager.add_error(
            state, error="Test error message", error_type="TestError"
        )
    ...
    def test_state_manager_update_state(self):
        """Test updating state."""
        state = AgentStateFactory.create_journal_state(
            user_id="test_user", tradition="test_tradition", journal_entries=[]
        )
...
class TestNodes:
    ...
    def test_llm_node_creation(self):
        ...
        node = TestLLMNode(
            name="test_llm_node", description="Test LLM node", task="test_task"
        )
...
class TestGraphBuilders:
    ...
    def test_base_graph_builder_creation(self):
        ...
        builder = TestGraphBuilder(
            name="test_graph", description="Test graph description"
        )
