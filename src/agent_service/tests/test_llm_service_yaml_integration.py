...
class TestLLMServiceYAMLIntegration:
    ...
    @pytest.fixture
    def llm_service_with_yaml(self, mock_llm, yaml_prompt_service, mock_provider_manager, mock_tool_registry):
    ...
    @pytest.mark.asyncio
    async def test_llm_service_uses_template_metadata(self, llm_service_with_yaml, mock_llm):
    ...
    @pytest.mark.asyncio
    async def test_llm_service_handles_empty_entries_with_yaml(self, llm_service_with_yaml):
    ...
    @pytest.mark.asyncio
    async def test_llm_service_template_rendering(self, llm_service_with_yaml, mock_llm):
    ...
    @pytest.mark.asyncio
    async def test_llm_service_fallback_behavior(self, mock_llm, mock_provider_manager, mock_tool_registry):
...
class TestLLMServiceMigration:
    ...
    @pytest.mark.asyncio
    async def test_migration_from_hardcoded_to_yaml(self, temp_templates_dir, mock_llm, mock_provider_manager, mock_tool_registry):
    ...
    @pytest.mark.asyncio
    async def test_backward_compatibility(self, temp_templates_dir, mock_llm, mock_provider_manager, mock_tool_registry):
    ...
    @pytest.mark.asyncio
    async def test_template_metadata_integration(self, temp_templates_dir, mock_llm, mock_provider_manager, mock_tool_registry):
