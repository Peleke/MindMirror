...
from agent_service.mcp.tools.base import ToolBackend, EffectBoundary
...
class TestJournalSummaryGraphTool:
    ...
    def test_journal_summary_tool_metadata(self):
        ...
        assert metadata.description == "Generate journal summaries using LangGraph workflow"
        assert metadata.backend == ToolBackend.LANGGRAPH
...
class TestPerformanceReviewGraphTool:
    ...
    def test_performance_review_tool_metadata(self):
        ...
        assert metadata.description == "Generate performance reviews using LangGraph workflow"
        assert metadata.backend == ToolBackend.LANGGRAPH
