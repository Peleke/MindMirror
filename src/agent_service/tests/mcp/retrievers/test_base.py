...
class TestRetrieverRegistry:
    ...
    def test_duplicate_registration(self, sample_documents):
        ...
        with pytest.raises(ValueError, match="Retriever test_retriever is already registered"):
...
class TestPropertyBased:
    ...
    def test_metadata_roundtrip(self):
        ...
        original_metadata = RetrieverMetadata(
            ...
            capabilities=["semantic_search", "structured_query", "graph_traversal", "filtering"],
            latency_ms=123.456,
        ...
        assert original_metadata.description == "A complex retriever with many capabilities"
...
class TestErrorHandling:
    ...
    def test_register_invalid_retriever(self):
        ...
        with pytest.raises(ValueError, match="Retriever must implement Retriever interface"):
