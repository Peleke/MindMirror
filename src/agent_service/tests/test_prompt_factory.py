...
class TestPromptFactory:
    ...
    def test_create_memory_store_with_config(self):
        ...
        config = PromptConfig(
            store_type=StoreType.MEMORY, cache_size=500, cache_ttl=1800
        )
    ...
    def test_create_gcs_store_not_implemented(self):
        ...
        config = PromptConfig(store_type=StoreType.GCS, gcs_bucket="test-bucket")

        # Mock the GCS store creation to avoid real client initialization
        with patch(
            "agent_service.llms.prompts.factory.GCSStorageLoader"
        ) as mock_loader:
    ...
    def test_create_firestore_not_implemented(self):
        ...
        config = PromptConfig(
            store_type=StoreType.FIRESTORE, firestore_collection="prompts"
        )
    ...
    def test_create_service_without_caching(self):
        ...
        config = PromptConfig(store_type=StoreType.MEMORY, enable_caching=False)
    ...
    def test_create_service_without_validation(self):
        ...
        config = PromptConfig(store_type=StoreType.MEMORY, enable_validation=False)
    ...
    def test_create_service_from_dict_invalid_store_type(self):
        ...
        config_dict = {"store_type": "invalid_store", "enable_caching": False}
    ...
    def test_create_service_from_dict_missing_required_fields(self):
        ...
        config_dict = {"store_type": "local"}  # Missing store_path
    ...
    def test_create_service_from_env_invalid_values(self):
        ...
        env_vars = {"PROMPT_STORE_TYPE": "invalid", "PROMPT_CACHE_SIZE": "not_a_number"}
    ...
    def test_create_service_with_override_config(self):
        ...
        base_config = PromptConfig(
            store_type=StoreType.MEMORY, cache_size=100, enable_caching=True
        )

        override_config = PromptConfig(
            store_type=StoreType.MEMORY, cache_size=200, enable_caching=False
        )

        service = PromptFactory.create_service_with_override(
