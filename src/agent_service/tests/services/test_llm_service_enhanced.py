...
class TestLLMServiceEnhanced:
    ...
    @pytest.fixture
    def enhanced_llm_service(self, mock_tool_registry, mock_prompt_service, mock_provider_manager):
    ...
    def test_enhanced_llm_service_creation_with_global_registry(self, mock_prompt_service, mock_provider_manager):
    ...
    async def test_execute_tool_with_version(self, enhanced_llm_service):
        ...
        result = await enhanced_llm_service.execute_tool("mock_tool", {"query": "test"}, version="1.0.0")
        assert len(result) == 1
    ...
    async def test_execute_subtool(self, enhanced_llm_service):
        ...
        result = await enhanced_llm_service.execute_subtool("mock_tool", "subtool1", {"arg": "value"})
    ...
    async def test_get_journal_summary_with_tool_registry(self, enhanced_llm_service):
        ...
        result = await enhanced_llm_service.get_journal_summary(journal_entries, "concise")
        
        assert "Summary of 2 entries in concise style" in result
    
    @pytest.mark.asyncio
    async def test_get_journal_summary_with_tool_registry_detailed(self, enhanced_llm_service):
        ...
        result = await enhanced_llm_service.get_journal_summary(journal_entries, "detailed")
    ...
    @pytest.mark.asyncio
    async def test_get_journal_summary_fallback_to_direct(self, mock_prompt_service, mock_provider_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_performance_review_with_tool_registry(self, enhanced_llm_service):
        ...
        result = await enhanced_llm_service.get_performance_review(journal_entries, "month")
    ...
    @pytest.mark.asyncio
    async def test_get_performance_review_with_tool_registry_quarter(self, enhanced_llm_service):
        ...
        result = await enhanced_llm_service.get_performance_review(journal_entries, "quarter")
    ...
    @pytest.mark.asyncio
    async def test_get_performance_review_fallback_to_direct(self, mock_prompt_service, mock_provider_manager):
    ...
    def test_get_tool_registry_health_error(self, mock_prompt_service, mock_provider_manager):
    ...
    @pytest.mark.asyncio
    async def test_journal_summary_tool_registry_error_handling(self, mock_prompt_service, mock_provider_manager):
    ...
    @pytest.mark.asyncio
    async def test_performance_review_tool_registry_error_handling(self, mock_prompt_service, mock_provider_manager):
        ...
        # Mock LLM response for fallback
        mock_llm = Mock()
        mock_llm.invoke.return_value.content = "SUCCESS: Fallback review\nIMPROVEMENT: More details\nPROMPT: What's next?"
        mock_provider_manager.create_model_with_fallback.return_value = mock_llm
...
class TestLLMServiceIntegration:
    ...
    def real_tool_registry(self):
        ...
        from agent_service.mcp.tools.graph_tools import JournalSummaryGraphTool, PerformanceReviewGraphTool
    ...
    @pytest.fixture
    def integration_llm_service(self, real_tool_registry, mock_prompt_service_integration, mock_provider_manager_integration):
    ...
    def test_integration_tool_metadata(self, integration_llm_service):
        ...
        journal_metadata = integration_llm_service.get_tool_metadata("journal_summary_graph")
        assert journal_metadata is not None
        assert journal_metadata["owner_domain"] == "journaling"
        assert journal_metadata["version"] == "2.1.0"
        
        review_metadata = integration_llm_service.get_tool_metadata("performance_review_graph")
