...
from agent_service.llms.prompts.models import StoreType, StorageConfig
...
class TestEndToEndDocker:
    ...
    async def test_full_application_startup(self):
        ...
        with patch('agent_service.llms.prompts.factory.PromptServiceFactory.create_from_environment') as mock_factory:
            mock_service = Mock()
