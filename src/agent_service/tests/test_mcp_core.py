...
class TestMCPPluginRegistry:
    ...
    def test_filter_plugins_by_tags(self):
        ...
        registry.register_plugin_class(TestPlugin, name="plugin1", tags=["test", "core"])
...
class TestUtilityFunctions:
    ...
    def test_validate_plugin_interface_invalid(self):
        ...
        with pytest.raises(ValueError, match="InvalidPlugin must inherit from MCPPlugin"):
...
class TestIntegration:
    ...
    async def test_complete_workflow(self):
        ...
        prompt_result = await plugin.get_prompt_content("workflow_prompt", {"context": "test context"})
