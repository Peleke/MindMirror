...
class TestLLMServiceProviderIntegration:
    ...
    def test_llm_service_initialization_with_provider_manager(self, mock_prompt_service, mock_provider_manager):
    ...
    def test_llm_service_backward_compatibility(self, mock_prompt_service):
        ...
        assert service.provider_manager is not None  # Should get global provider manager
    
    @pytest.mark.asyncio
    async def test_get_journal_summary_with_provider_manager(self, mock_prompt_service, mock_provider_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_performance_review_with_provider_manager(self, mock_prompt_service, mock_provider_manager):
    ...
    def test_get_llm_with_specific_provider(self, mock_prompt_service, mock_provider_manager):
    ...
    def test_get_provider_status_specific(self, mock_prompt_service, mock_provider_manager):
    ...
    def test_health_check_with_provider_integration(self, mock_prompt_service, mock_provider_manager):
    ...
    def test_health_check_degraded_without_working_providers(self, mock_prompt_service, mock_provider_manager):
    ...
    @pytest.mark.asyncio
    async def test_fallback_to_deprecated_llm_creation(self, mock_prompt_service, mock_provider_manager):
        """Test fallback to deprecated direct ChatOpenAI creation."""
        # Make provider manager fail
        mock_provider_manager.create_model_with_fallback.side_effect = Exception("Provider failed")
...
class TestLLMServiceErrorHandling:
    ...
    def test_error_handling_in_get_llm(self, mock_prompt_service, mock_provider_manager):
        """Test error handling in get_llm method."""
        mock_provider_manager.create_model_with_fallback.side_effect = Exception("Provider error")
    ...
    @pytest.mark.asyncio
    async def test_error_handling_in_journal_summary(self, mock_prompt_service, mock_provider_manager):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_in_performance_review(self, mock_prompt_service, mock_provider_manager):
