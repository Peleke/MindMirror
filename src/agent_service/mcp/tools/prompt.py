...
class PromptTool(MCPTool):
        ...
        return {
            ...
            "properties": {
                "variables": {
                    ...
                    "required": [k for k, v in self.prompt_config.variables.items() 
    ...
    async def _execute_structured_prompt(self, variables: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if "context" in processed_content:
                processed_content["context"] = format_nested_dict(processed_content["context"], variables)
    ...
    async def _execute_conditional_prompt(self, variables: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            matched_condition = "default"  # Default to "default" if no condition matches
...
class PromptTemplateManager:
    ...
    def __init__(self):
        ...
        self.original_configs: Dict[str, PromptConfig] = {}  # Store original PromptConfig objects
