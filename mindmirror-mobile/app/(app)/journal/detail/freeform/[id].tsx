...
export default function FreeformDetailScreen() {
  ...
  const entry = data.journalEntry as FreeformJournalEntry;

  return (
    <SafeAreaView className="h-full w-full">
      <VStack className="h-full w-full bg-background-0">
        <AppBar title="Freeform Entry" showBackButton onBackPress={handleBackPress} />
