...
# Runs all necessary scripts to set up production environment
...
echo "=========================================================="
echo -e "${BLUE}MindMirror Production Bootstrap${NC}"
echo "=========================================================="
echo ""
...
echo -e "${YELLOW}Project: mindmirror-prod${NC}"
echo ""
...
echo "  • GCS State Bucket: gs://mindmirror-tofu-state"
echo "  • Artifact Registry: us-east4-docker.pkg.dev/mindmirror-prod/mindmirror"
echo "  • Service Account: github-actions-production@mindmirror-prod.iam.gserviceaccount.com"
echo "  • WIF Pool: github-pool"
echo "  • WIF Provider: github-oidc"
echo ""
echo -e "${BLUE}Next Steps:${NC}"
echo "  1. Add GitHub repository secret:"
echo "     ${YELLOW}GCP_PRODUCTION_PROJECT_NUM${NC}"
echo "     Value: Run this command to get it:"
echo "     ${YELLOW}gcloud projects describe mindmirror-prod --format='value(projectNumber)'${NC}"
echo ""
echo "  2. Test deployment workflow:"
echo "     ${YELLOW}git push origin main${NC}"
echo ""
echo "  3. Monitor workflow execution:"
echo "     ${YELLOW}gh run list --workflow production-deploy.yml --limit 1${NC}"
echo ""
