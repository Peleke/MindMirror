...
from src.clients.qdrant_client import CeleryQdrantClient, SearchResult, get_celery_qdrant_client
...
class TestCeleryQdrantClient:
    ...
    async def test_get_or_create_knowledge_collection(self, mock_qdrant_base):
        ...
        with patch.object(client, '_create_collection', new_callable=AsyncMock) as mock_create:
    ...
    async def test_get_or_create_personal_collection(self, mock_qdrant_base):
        ...
        with patch.object(client, '_create_collection', new_callable=AsyncMock) as mock_create:
            ...
            result = await client.get_or_create_personal_collection("stoicism", "user-123")
    ...
    async def test_index_personal_document(self, mock_qdrant_base):
        ...
        with patch.object(client, 'get_or_create_personal_collection', new_callable=AsyncMock) as mock_get_collection:
            with patch.object(client, 'index_document', new_callable=AsyncMock) as mock_index:
